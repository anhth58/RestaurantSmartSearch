package com.me.restaurantsmartsearch.view;
...
import com.me.restaurantsmartsearch.adapter.TextWatcherAdapter;

/**
 * Created by Laptop88T on 11/17/2016.
 */
public class CusEditText extends EditText implements View.OnTouchListener, View.OnFocusChangeListener, TextWatcherAdapter.TextWatcherListener {
    ...
    private void initIcon() {
        ...
        if (xD == null) {
            xD = getResources().getDrawable(R.drawable.delete_user);
        }
